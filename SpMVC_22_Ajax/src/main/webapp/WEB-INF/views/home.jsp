...
<script>
	$(function() {
		...
		// jq의 event handler를 작성할 때
		// $("#call_ajax").click 이라고 작성을 하는데
		// ajax 등을 사용하여 서버로 부터 나중에 가져온 페이지는
		// 해당 이벤트 핸들러로 작동이 안된다.
		// ajax를 고려할 때 아래와 같은 핸들러를 작성하는 것을
		// 자주 연습하자.
...
<section id="main">
	...
	<button id="call_msg">message 호출</button>
