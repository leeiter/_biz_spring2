 ...
 * 
 * UserDetails 이라는 interface를 implements 하여 작성한다.
 * 
 * 2020-04-10
 * User 클래스를 상속받아 만든 UserVO를
 * UserDetails 인터페이스를 implements한 UserDetailsVO로 변경
 * 
 * UserDetails를 implements하면 method를 Override 하라는 지시가 있다.
