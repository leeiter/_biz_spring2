...
public class MailSendService {
	...
	public String join_send(UserDetailsVO userVO) throws UnsupportedEncodingException {
		...
		// localhost:8080/sec/join/email/leeiter/iterlees@gmail.com
		// 암호화 된 상태
		/*
		 * jasypt를 사용하여 usrname과 email을 암호화 하였더니
		...
		email_message.append("<p>회원가입절차를 마무리하려면</p><br/>");
		email_message.append("<p>Email 인증을 하여야 합니다.</p>");
