...
<script>
	...
	socket.onmessage = function(e) {
	    ...
	    if(mJson.msg && mJson.msg == 'userList') {
	    	...
	    	// js코드 method
	    	// userList 객체 그룹 중에서 각요소의 키값만 추출하여
	    	// 배열로 만들어 달라
	    ...
	    let html = "<div class='from bg-secondary text-white'>"
	...
	$(document).on("click", "#btn_send", function() {
		...
		let html = "<div class='to text-right bg-warning text-white'>"
		html += "<span class='userName'>"
		html += "나 : "
		html += "</span>"
...
<section class="container-fluid">
	<div id="message_list" class="bg-light text-dark">
	</div>
</section>
<section class="container-fluid">
	<form>
		...
		<div class="form-group">
			...
			<input id="message" class="form-control" placeholder="message 입력">
		</div>
